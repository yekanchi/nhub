...
string GetTitle()
{
	return "{$CP949=네이버 파파고 번역(SMT)$}{$CP950=Naver papago 翻譯(SMT)$}{$CP0=Naver papago translate(SMT)$}";
}
...
{		
	...
	string ret = "";
	uintptr http = HostOpenHTTP("https://openapi.naver.com/v1/language/translate", UserAgent, SendHeader, Post);
	if (http != 0)
	{
