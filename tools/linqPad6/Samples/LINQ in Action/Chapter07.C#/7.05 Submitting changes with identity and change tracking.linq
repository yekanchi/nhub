...
//7.5: Submitting changes with identity and change tracking
...
LinqBooksDataContext context3 = new LinqBooksDataContext(Connection.ConnectionString);
context3.Subjects.Where(s => s.SubjectId == Id).Dump();
