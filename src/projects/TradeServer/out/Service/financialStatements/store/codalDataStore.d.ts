import { ICostOfGoods, IIncomeStatement, IN10Letter, IN30ProductItem, IN30Report, IN3xLetter, ISaleAndCost } from "data/financialStatements";
import { ICodalDataStore } from "data/financialStatements/store";
