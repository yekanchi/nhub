import { IN31BuyInvestmentItem, IN31DividentIncomeItem, IN31IndustryGroupInvestmentItem, IN31PeriodicPortfolioInItem, IN31PeriodicPortfolioOutItem, IN31Report, IN31SellInvestmentItem, IN3xLetter } from "data/financialStatements";
import { ICodalN31ReportDataProvider } from "data/financialStatements/provider";
