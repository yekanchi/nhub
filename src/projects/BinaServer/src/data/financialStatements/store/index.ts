import {
    IBalanceSheet, ICostOfGoods,
    IIncomeStatement,
    IN10Letter,
    IN30ProductItem,
    IN30Report,
    IN3xLetter, ISaleAndCost
} from "..";
import {CodalDataStore} from "./codalDataStore";
...
export const codalDataStore: ICodalDataStore = new CodalDataStore();